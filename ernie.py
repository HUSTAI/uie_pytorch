...
_CHECKPOINT_FOR_DOC = "ernie-base-uncased"
_CONFIG_FOR_DOC = "ErnieConfig"
_TOKENIZER_FOR_DOC = "ErnieTokenizer"
...
def load_tf_weights_in_ernie(model, config, tf_checkpoint_path):
...
class ErnieEmbeddings(nn.Module):
    ...
    def forward(
        self, input_ids=None, token_type_ids=None, position_ids=None, task_type_ids=None, inputs_embeds=None, past_key_values_length=0
    ):
